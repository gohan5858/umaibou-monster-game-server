...
pub async fn join_matching(
    ...
    println!("📥 POST /api/matching/join: matching_id={}, player_id={}", req.matching_id, req.player_id);
    ...
    if let Some(session) = sessions.get_mut(&req.matching_id) {
        ...
        println!("✅ Matching successful: player_a={}, player_b={}", session.player_a.id, req.player_id);
        ...
        println!("❌ Matching session not found: matching_id={}", req.matching_id);
