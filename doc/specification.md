...
1. プレイヤーAがマッチングIDを生成し、このIDをサーバーにマッチング待ちとして登録する。
2. 合わせて、プレイヤーAは生成したマッチングIDをBluetoothで近くのプレイヤーにブロードキャストする。
3. 近くにいたプレイヤーBが、プレイヤーAのマッチングIDを受信し、サーバーに対してそのIDでマッチング要求を送信する。
